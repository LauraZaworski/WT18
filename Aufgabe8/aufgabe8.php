...
<head>
    ...
    */
   	 ...
   	 */
   	$dbh = new DB('_s0564535__mockupdatadb', 'db.f4.htw-berlin.de:3306', 's0564535', 'kaiserschmarrn');
...
<body>
	<?php
     ...
     //$dbh->add(array("Max", "Mustermann", "max@muster.de", "1234"));
     //$dbh->delete(55);
     //$dbh->edit(array("Jan", "Justermann", "jan@juster.de", "5678", 53));
                  ...
                  '<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                     <div class="thumbnail">
                        ...
                        <div class="buttons-edit">
                           <a class="btn btn-default btn-sm" href="'.htmlspecialchars($SERVER["PHP_SELF"]).' ?command=edit&id='.$teilnehmerin["id"].'">Edit</a>
                           <a class="btn btn-default btn-sm" href="'.htmlspecialchars($SERVER["PHP_SELF"]).' ?command=delete&id='.$teilnehmerin["id"].'">Delete</a>
                        </div>
                     </div>
                  </div>';
               }
